Добавил в бота функцию на своё усмотрение. Бот может переводить любое количество валюты и выдаёт сумму учитывая это количество, а не показывает цену одной единыцы
